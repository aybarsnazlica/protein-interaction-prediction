...
ATOM_NAMES = "/u21/aybars/scratch/atom_names"
FEAT_BINARY = (
    "lib/dock_atom_feat3_sym1_pdb_lrmsd_withnat/feat"
)
# EXPECTED = "/u21/aybars/scratch/contacts-heterodimer"
EXPECTED = "/u21/aybars/scratch/contacts-randrot"
# TOP_DIR = CURRENT_DIR / 'work' / 'training_data'
TOP_DIR = CURRENT_DIR / "work" / "training_data_randrot"
DIST = "5"
TAKE_LOG = "1"
