...
TRAIN_EVALS_PATH = PROJECT_DIR / "reports" / f"pytorch_train_{TIMESTAMP}.csv"
NORMALIZER_PATH = MODEL_DIR_PATH / f"normalizer_{TIMESTAMP}.pkl"
ROC_CURVE_FIG = (
    PROJECT_DIR / "reports" / "figures" / f"pytorch_roc_curve_{TIMESTAMP}.png"
)
PR_CURVE_FIG = PROJECT_DIR / "reports" / "figures" / f"pytorch_pr_curve_{TIMESTAMP}.png"
...
def main():
    ...
    # print(summary(saved_model, input_size=(500, 1)))
